  ...
  if ((randomDice[0].ma !== randomDice[1].ma) && (randomDice[1].ma !== randomDice[2].ma) && (randomDice[0].ma !== randomDice[2].ma)) {
    if (demKhacNhau === 3 && demCap === 0) {
      ...
      if (remBef === 'nai') {
        ...
        if (randomDice[0].ma !== 'cua' && randomDice[0].ma !== 'cua' && randomDice[2].ma !== 'cua') {
          resultDice.push({ ma: 'cua', hinhAnh: './img/cua.png' });
        } else {
          resultDice.push({ ma: randomDice[2].ma, hinhAnh: './img/' + randomDice[2].ma + '.png' });
        }
      } else if (remBef === 'cua') {
        resultDice.push({ ma: randomDice[0].ma, hinhAnh: './img/' + randomDice[0].ma + '.png' });
        resultDice.push({ ma: randomDice[1].ma, hinhAnh: './img/' + randomDice[1].ma + '.png' });
        if (randomDice[0].ma !== 'ga' && randomDice[0].ma !== 'ga' && randomDice[2].ma !== 'ga') {
        ...
        resultDice.push({ ma: randomDice[0].ma, hinhAnh: './img/' + randomDice[0].ma + '.png' });
        resultDice.push({ ma: randomDice[1].ma, hinhAnh: './img/' + randomDice[1].ma + '.png' });
        if (randomDice[0].ma !== 'tom' && randomDice[0].ma !== 'tom' && randomDice[2].ma !== 'tom') {
        ...
        resultDice.push({ ma: randomDice[0].ma, hinhAnh: './img/' + randomDice[0].ma + '.png' });
        resultDice.push({ ma: randomDice[1].ma, hinhAnh: './img/' + randomDice[1].ma + '.png' });
        if (randomDice[0].ma !== 'bau' && randomDice[0].ma !== 'bau' && randomDice[2].ma !== 'bau') {
        ...
        resultDice.push({ ma: randomDice[0].ma, hinhAnh: './img/' + randomDice[0].ma + '.png' });
        resultDice.push({ ma: randomDice[1].ma, hinhAnh: './img/' + randomDice[1].ma + '.png' });
        if (randomDice[0].ma !== 'ca' && randomDice[0].ma !== 'ca' && randomDice[2].ma !== 'ca') {
        ...
        resultDice.push({ ma: randomDice[0].ma, hinhAnh: './img/' + randomDice[0].ma + '.png' });
        resultDice.push({ ma: randomDice[1].ma, hinhAnh: './img/' + randomDice[1].ma + '.png' });
        if (randomDice[0].ma !== 'nai' && randomDice[0].ma !== 'nai' && randomDice[2].ma !== 'nai') {
